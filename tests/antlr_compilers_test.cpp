...
void testAdvancedFeatures() {
    ...
    ANTLRCSSCompiler cssCompiler;
    auto cssResult = cssCompiler.compileCSS(complexCSS);
    std::cout << "复杂CSS编译: " << (cssResult.success ? "成功" : "失败") << std::endl;
    ...
    ANTLRJSCompiler jsCompiler;
    auto jsResult = jsCompiler.compileJS(complexJS);
    std::cout << "复杂JavaScript编译: " << (jsResult.success ? "成功" : "失败") << std::endl;
